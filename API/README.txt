 ...
 ###############  ETAPES A SUIVRE POUR UTILISER/TESTER NOTRE API BASEE SUR LE MODELE DE BAYES NAIF MULTINOMINAL  ###############

 Pour utiliser/tester notre api, il suffit de suivre les etapes suivantes :
